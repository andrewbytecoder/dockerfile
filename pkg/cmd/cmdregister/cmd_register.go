...
import (
	...
	"github.com/andrewbytecoder/dockerfile/pkg/cmd/gops"
	"github.com/andrewbytecoder/dockerfile/pkg/cmd/httpserver"
	"github.com/andrewbytecoder/dockerfile/pkg/cmd/httpstat"
	"github.com/andrewbytecoder/dockerfile/pkg/cmd/psutil"
	"github.com/andrewbytecoder/dockerfile/pkg/cmd/version"
...
func (n *NexaCommand) RegisterCmd(ctx *ctx.Ctx) {
	...
	n.AddCommand(httpserver.GetHttpServerCmd(ctx))
